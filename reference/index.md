...
- [`plot(`*`<IndepAssoc>`*`)`](https://mostafa-abbas.github.io/IndepAssoc/reference/plot.IndepAssoc.md)
...
- [`print(`*`<IndepBalance>`*`)`](https://mostafa-abbas.github.io/IndepAssoc/reference/print.IndepBalance.md)
...
- [`subgroup_analysis()`](https://mostafa-abbas.github.io/IndepAssoc/reference/subgroup_analysis.md)
  : Subgroup Analysis
- [`summary(`*`<IndepAssoc>`*`)`](https://mostafa-abbas.github.io/IndepAssoc/reference/summary.IndepAssoc.md)
